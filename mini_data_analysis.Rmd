...
```{r stacked histogram of tree genera surrounding VGH area}
...
To determine the distribution of Maple trees within the major streets, the data can be further subsetted into a new tibble where only trees under the Acer genus are retained and count summaries are made based on common name and linking the tree to the street it was recorded on. Further, a new variable can be made averaging the count of a particular Maple tree across the four streets.
...
```{r plot of the distribution of Acer trees around VGH}
